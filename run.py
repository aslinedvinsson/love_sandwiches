...
def validate_data(values):
    """
    Inside the try, converts allt string values into integers.
...
"""
Refactoring functions to the one below outcommented functions 
def update_sales_worksheet(data):
   
    c:Update sales worksheet, add new row with the list data provided.
...
def update_surplus_worksheet(data):
   ...
   c: Update surplus worksheet, add new row with the list data provided.
...
def calculate_stock_data(data):
    """
    Calculate the avarage stock for each item tyoe, adding 10%
    """
    print('Calculationg stock data...\n')
    new_stock_data = []
